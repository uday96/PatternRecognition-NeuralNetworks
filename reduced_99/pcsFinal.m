...
for k=1:32
    p =zeros(len,5);
    obj1 = gmdistribution.fit(Datasets_train{1}(:,1:dim-1),k,'Regularize',0.0001);
    obj2 = gmdistribution.fit(Datasets_train{2}(:,1:dim-1),k,'Regularize',0.0001);
    obj3 = gmdistribution.fit(Datasets_train{3}(:,1:dim-1),k,'Regularize',0.0001);
    obj4 = gmdistribution.fit(Datasets_train{4}(:,1:dim-1),k,'Regularize',0.0001);
    obj5 = gmdistribution.fit(Datasets_train{5}(:,1:dim-1),k,'Regularize',0.0001);
