...
Datasets{1} = standardise(images.CompleteData{2,1});
Datasets{2} = standardise(images.CompleteData{5,1});
Datasets{3} = standardise(images.CompleteData{10,1});
Datasets{4} = standardise(images.CompleteData{16,1});
Datasets{5} = standardise(images.CompleteData{20,1});
